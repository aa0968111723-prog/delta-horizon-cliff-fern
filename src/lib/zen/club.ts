...
export const CLUB_SHORT = "禪學社";
export const CLUB_HANDLE = "@tku.zen";
export const APP_NAME = "禪光工作室";
export const APP_TAGLINE = "淡江大學禪學社 AI 創作中控台";
...
export const CLUB_VOICE =
  "像一個學長姐坐在你旁邊講話：安靜、具體、不說教。會承認自己也會累，不保證改變人生，只邀你坐一下。";
...
export const CLUB_INTRO_LONG =
  "我們是淡江大學禪學社。社課不用盤腿，也不用信什麼，就是一週給自己一小段安靜的時間：坐一下、講幾句話、把最近的事情放下來看看。來的人有大一新生，也有寫論文寫到懷疑人生的研究生。第一次來什麼都不會，完全可以。";

export const CLUB_CTAS = [
  "來坐一下",
  "社課見",
  "先存起來",
  "私訊問我們",
...
export const CLUB_SLOGANS = ["坐下來，就是開始。", "慢一點，也走得到。", "不用準備好才能來。"];

export const CLUB_HASHTAGS = [
  "#淡江大學",
  "#淡江禪學社",
  "#淡江社團",
  "#淡水",
...
export const EVENT_KINDS = [
  { id: "class", label: "社課", hint: "每週固定，最常出現的內容。" },
  { id: "tea", label: "茶會", hint: "邊喝茶邊聊，門檻最低的第一次。" },
  { id: "sit", label: "禪坐體驗", hint: "十到二十分鐘的靜坐練習。" },
  { id: "talk", label: "講座／分享", hint: "邀請講者或社員分享。" },
  { id: "outdoor", label: "戶外禪", hint: "河邊、校園散步、感官練習。" },
  { id: "camp", label: "營隊／共修", hint: "半天以上的深度活動。" },
  { id: "welcome", label: "迎新", hint: "開學招生檔期的主力。" },
  { id: "recruit", label: "招生", hint: "社博、擺攤、線上招生。" },
  { id: "film", label: "電影賞析", hint: "看片加討論，適合冬天室內。" },
  { id: "other", label: "其他", hint: "自訂活動。" },
] as const;

export type EventKindId = (typeof EVENT_KINDS)[number]["id"];

export function eventKindLabel(id: string): string {
...
/** 給 prompt 用的品牌段落。 */
export function describeClub(): string {
  return [

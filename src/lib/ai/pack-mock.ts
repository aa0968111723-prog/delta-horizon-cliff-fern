  ...
  return [
    {
      ...
      imagePrompt: `Cinematic night campus gathering at Tamkang University Tamsui, three soft overlapping lights amber teal and dusty rose, students sitting quietly with tea cups, airy film still, not religious temple, not monk robes, shallow depth, IG 4:5, ${name}`,
      headline: clip("最近是不是\n很久沒坐好"),
      subhead: `${name} · 一個晚上`,
    },
    {
      ...
      imagePrompt: `Warm indoor student tea circle, hands around cups, casual clothes, Tamkang campus life, turtle mascot sticker in corner, linen beige and teal, photoreal editorial, not luxury, not temple, ${name}`,
      headline: clip("帶一個朋友\n就好"),
      subhead: "不用先懂禪",
    },
    {
      ...
      imagePrompt: `Tamsui dusk riverside from MRT commute, wind, distant campus lights, one student walking with backpack, naturalistic photography, muted film colors, not tourist postcard, ${name}`,
      headline: clip("捷運上滑完\n更累了"),
      subhead: "晚上其實可以停一下",
    },
  ];

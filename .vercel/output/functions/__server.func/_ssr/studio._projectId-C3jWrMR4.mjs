...
import { C as createLogoLayer, H as snapMove, K as useStudio, L as pagesOf, M as logoUsageLabel, N as matchesAssetQuery, P as migrateBrief, S as createLineLayer, T as createTextLayer, V as rotateByPointer, W as textOverflows, a as Button, j as kindFromCategory, m as activeArtboard, n as ASSET_DRAG_MIME, s as EmptyState, t as ASSET_CATEGORIES, v as cn, w as createShapeLayer, x as createImageLayer, z as resizeBox } from "./empty-state-DJ_-9JB5.mjs";
import { n as Textarea, t as Input } from "./input-DgRZflFK.mjs";
import { A as Frame, B as ChevronDown, D as Image, E as Images, F as Copy, H as AlignLeft, I as Circle, L as ChevronUp, M as Eye, N as EyeOff, O as History, R as ChevronRight, S as LockOpen, T as Layers, U as AlignRight, W as AlignCenter, _ as Plus, b as Minus, c as Star, d as Scan, f as Save, g as Redo2, h as RefreshCw, i as Type, l as Square, m as RotateCcw, n as Upload, o as Trash2, p as Rows3, r as Undo2, u as Sparkles, w as LayoutGrid, x as Lock, y as MousePointer2, z as ChevronLeft } from "../_libs/lucide-react.mjs";
...
import { _ as getAssetStorage, a as Sheet, d as PlanResult, f as describeAdapter, g as useUi, h as toBriefInput, i as ScrollArea, l as BriefFields, m as getCampaignAiStatus, n as Route, o as SheetContent, p as generateCampaignPlan, r as SaveIndicator, s as SheetTitle, u as EditorAgent } from "./router-C_PWIgcC.mjs";
import { t as ArtboardView } from "./artboard-view-BQUTim4K.mjs";
import { t as useAssetUrls } from "./use-asset-urls-DlkdIQ_Y.mjs";
import { n as STUDIO_FONTS, r as Switch, t as FONT_WEIGHTS } from "./fonts-DYRHEfSa.mjs";
import { t as inspectQuality } from "./quality-B-PHXIAk.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/studio._projectId-C3jWrMR4.js
...
function StudioWorkspace({ projectId }) {
	...
	const qa = inspectQuality(artboard, brand, project.copy);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
						to: "/export",
						className: cn("hidden px-2 text-xs tabular-nums lg:inline", qa.score >= 85 ? "text-success" : qa.score >= 70 ? "text-warn" : "text-danger"),
						children: qa.score
					})
				]
			}),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Sheet, {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SheetContent, {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SheetTitle, {
						className: "mb-3",
						children: panel === "layers" ? "圖層" : panel === "assets" ? "素材" : panel === "copy" ? "文字" : panel === "inspect" ? "屬性" : panel === "versions" ? "版本" : "AI 操作"
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "min-h-0 flex-1 overflow-y-auto",
						children: [

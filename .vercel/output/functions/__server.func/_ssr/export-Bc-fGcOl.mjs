...
import { E as cssFilter, F as normalizeCrop, I as normalizeFilter, K as useStudio, L as pagesOf, a as Button, m as activeArtboard, s as EmptyState, u as LoadingState, v as cn } from "./empty-state-DJ_-9JB5.mjs";
import { P as Download, j as FolderKanban } from "../_libs/lucide-react.mjs";
import { a as SelectItem, i as SelectContent, l as getAssetBlob, n as Label, o as SelectTrigger, r as Select, s as SelectValue } from "./select-DgCb9BIh.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/export-Bc-fGcOl.js
...
function QualityPanel({ artboard, brand, copy }) {
	const select = useStudio((s) => s.select);
	const { score, issues } = inspectQuality(artboard, brand, copy);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: cn("font-display text-4xl tabular-nums tracking-tight", score >= 85 ? "text-success" : score >= 70 ? "text-warn" : "text-danger"),
				children: score
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "mt-1 text-xs text-muted",
				children: "以安全區、對比、字級、品牌色與文案規則計分。"
			})
		] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
			className: "space-y-2",
			children: issues.map((issue) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
				type: "button",
				className: cn("w-full rounded-lg px-3 py-3 text-left shadow-[var(--shadow-border)]", issue.severity === "fail" && "bg-danger/10", issue.severity === "warn" && "bg-warn/10", issue.severity === "pass" && "bg-success/10"),
				onClick: () => issue.layerId && select(issue.layerId),
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-xs tracking-wide text-muted uppercase",
						children: issue.severity === "fail" ? "必須修正" : issue.severity === "warn" ? "建議" : "通過"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {

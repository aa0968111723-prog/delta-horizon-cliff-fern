//#region node_modules/.nitro/vite/services/ssr/assets/status-BrzQjlVh.js
var STATUS_META = {
	idea: {
		label: "想法",
		tone: "default",
...
function migrateStatus(raw, hasPlan) {
...
/** 從尺寸與頁數猜內容型態，用在舊資料遷移。 */
function inferContentKind(formatId, slideCount) {
...
//#endregion
export { inferContentKind as a, contentKindLabel as i, CONTENT_KIND_ORDER as n, migrateStatus as o, STATUS_META as r, CONTENT_KIND_META as t };

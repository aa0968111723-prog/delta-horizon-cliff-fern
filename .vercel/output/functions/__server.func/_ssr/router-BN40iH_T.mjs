...
import { a as GOALS, d as formatById, i as FORMATS, n as BriefInputSchema, v as uid$1 } from "./schema-DPsPUDiS.mjs";
...
import { C as emptyBrief, H as Button, M as pagesOf, V as useStudio, W as cn, a as DELIVERABLE_OPTIONS, c as TEMPLATE_META, h as createImageLayer, k as migrateBrief, m as createGeneratedAsset, r as ASSET_NEED_LABEL, s as PAGE_ROLE_LABEL, w as formatsFromBrief, y as createTextLayer } from "./studio-store-xcJ-mtNt.mjs";
import { n as Input, r as Textarea, t as getAssetStorage } from "./asset-storage-CpaE1sxh.mjs";
import { E as LoaderCircle, c as SwatchBook, d as Sparkles, j as House, k as Images, o as TriangleAlert, q as Check, t as X, y as PenTool } from "../_libs/lucide-react.mjs";
...
import { a as hydrateSeedAsset, t as Badge } from "./badge-DWCS9kce.mjs";
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/payload-BN6yPUfS.js
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/router-BN40iH_T.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("aside", {
				className: "sticky top-0 hidden h-dvh w-[4.5rem] shrink-0 flex-col border-r border-border bg-surface lg:flex",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
						to: "/",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("nav", {
						...
						children: NAV.map((item) => {
							...
							return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
								...
								className: cn("flex min-h-12 flex-col items-center justify-center gap-1 rounded-md text-xs transition-colors", active ? "bg-surface-2 text-fg" : "text-muted hover:bg-surface-2 hover:text-fg"),
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: NAV.map((item) => {
							...
							return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
								to: dest.to,
								params: "params" in dest ? dest.params : void 0,
								className: cn("flex h-14 min-h-11 flex-col items-center justify-center gap-1 text-xs", item.match === "assistant" && "-mt-3 h-16 rounded-2xl bg-accent text-accent-fg shadow-[var(--shadow-artboard)]", item.match !== "assistant" && (active ? "text-fg" : "text-muted")),
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(item.icon, { className: cn(item.match === "assistant" ? "size-5" : "size-4") }), item.label]
							}, item.match);
						})
					})
				})]
...
var LONG_RHYTHM = [
	...
	},
	{
		daysBefore: 10,
		title: "最近連休息都在趕嗎？",
		angle: "從淡江學生最近的壓力與生活切入",
		type: "IG Post"
	},
	{
		daysBefore: 7,
		title: "活動主視覺",
		angle: "Hook、活動名、日期與地點一眼看懂",
		type: "Carousel"
	},
	{
		daysBefore: 4,
		title: "為什麼值得來",
		angle: "說清楚能得到的陪伴、空間與朋友感",
		type: "Threads"
	},
	{
		daysBefore: 2,
		title: "你最近是哪一種狀態？",
		angle: "用投票讓學生先參與，不只看廣告",
		type: "互動投票"
	},
	{
		daysBefore: 1,
		title: "明晚見",
		angle: "一句倒數，加上時間、地點與報名方式",
		type: "倒數"
	},
	{
		daysBefore: 0,
...
function atPublishHour(date) {
	return setHours(date, 19);
}
function buildCampaignRhythm(campaign, now = /* @__PURE__ */ new Date()) {
	...
	return rhythm.filter((beat) => beat.daysBefore <= Math.max(leadDays, 0) || beat.daysBefore <= 0).map((beat, index) => {
...
function contentTypeDeliverables(type) {
	return {
		post: [
			"IG Post",
			"Threads",
...
var seedItems = buildCampaignRhythm(SEED_CAMPAIGN, /* @__PURE__ */ new Date("2026-09-16T00:00:00+08:00"));
var useCreative = create()(persist((set, get) => ({
	hydrated: false,
	...
	updateCampaign: (id, patch) => set((state) => ({ campaigns: state.campaigns.map((campaign) => campaign.id === id ? {
		...campaign,
		...patch,
		updatedAt: Date.now()
	} : campaign) })),
	generateRhythm: (campaignId) => {
		...
		set((state) => ({ contentItems: [...state.contentItems.filter((item) => item.campaignId !== campaignId), ...generated] }));
		return generated;
	},
	setContentStatus: (id, status) => set((state) => ({ contentItems: state.contentItems.map((item) => item.id === id ? {
		...item,
		status,
		publishedAt: status === "published" ? (/* @__PURE__ */ new Date()).toISOString() : item.publishedAt,
		updatedAt: Date.now()
	} : item) })),
	linkProject: (id, projectId) => set((state) => ({ contentItems: state.contentItems.map((item) => item.id === id ? {
		...item,
		projectId,
		status: "creating",
		updatedAt: Date.now()
...
var styles_default = "/assets/styles-QH_IBw2N.css";
var APP_NAME = "禪作所";
var Route$9 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "淡江大學禪學社的一人 AI Creative Marketing Studio"
			},
			{
				name: "theme-color",
				content: "#F4F1EA"
...
var $$splitComponentImporter$8 = () => import("./routes-BSyKzhKT.mjs");
var Route$8 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$8, "component") });
var $$splitComponentImporter$7 = () => import("./assets-s7P7ksiX.mjs");
var Route$7 = createFileRoute("/assets")({ component: lazyRouteComponent($$splitComponentImporter$7, "component") });
var $$splitComponentImporter$6 = () => import("./assistant-BuCgbOHL.mjs");
var Route$6 = createFileRoute("/assistant")({ component: lazyRouteComponent($$splitComponentImporter$6, "component") });
var $$splitComponentImporter$5 = () => import("./brand-CMMrxdpf.mjs");
var Route$5 = createFileRoute("/brand")({ component: lazyRouteComponent($$splitComponentImporter$5, "component") });
var $$splitComponentImporter$4 = () => import("./campaigns-ENERAXG1.mjs");
var Route$4 = createFileRoute("/campaigns")({ component: lazyRouteComponent($$splitComponentImporter$4, "component") });
var $$splitComponentImporter$3 = () => import("./export-CiU57pgN.mjs");
var Route$3 = createFileRoute("/export")({ component: lazyRouteComponent($$splitComponentImporter$3, "component") });
var $$splitComponentImporter$2 = () => import("./studio-DXiWF76P.mjs");
var Route$2 = createFileRoute("/studio")({ component: lazyRouteComponent($$splitComponentImporter$2, "component") });
var $$splitComponentImporter$1 = () => import("./studio.index-C8z-1U0I.mjs");
var Route$1 = createFileRoute("/studio/")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./studio._projectId-BQGBYG48.mjs");
...
var AssistantRoute = Route$6.update({
	id: "/assistant",
	path: "/assistant",
	getParentRoute: () => Route$9
});
var BrandRoute = Route$5.update({
	id: "/brand",
	path: "/brand",
	getParentRoute: () => Route$9
});
...
var ExportRoute = Route$3.update({
	id: "/export",
	path: "/export",
	getParentRoute: () => Route$9
});
...
var StudioRouteChildren = {
	StudioProjectIdRoute: Route.update({
		id: "/$projectId",
		path: "/$projectId",
		getParentRoute: () => StudioRoute
	}),
...
//#endregion
export { getCampaignAiStatus as _, SaveIndicator as a, ErrorState as b, SheetContent as c, useUi as d, BriefFields as f, generateCampaignPlan as g, describeAdapter as h, contentTypeDeliverables as i, SheetTitle as l, PlanResult as m, Route as n, ScrollArea as o, EditorAgent as p, useCreative as r, Sheet as s, router_exports as t, AssistantForm as u, toBriefInput as v, LoadingState as x, EmptyState as y };

...
import { A as formatsFromBrief, K as useStudio, L as pagesOf, P as migrateBrief, T as createTextLayer, a as Button, b as createGeneratedAsset, c as ErrorState, d as PAGE_ROLE_LABEL, f as TEMPLATE_META, k as emptyBrief, o as DELIVERABLE_OPTIONS, r as ASSET_NEED_LABEL, v as cn, x as createImageLayer } from "./empty-state-DJ_-9JB5.mjs";
import { n as Textarea, t as Input } from "./input-DgRZflFK.mjs";
import { C as LoaderCircle, P as Download, V as Check, a as TriangleAlert, j as FolderKanban, s as SwatchBook, t as X, u as Sparkles, v as PenTool } from "../_libs/lucide-react.mjs";
import { a as SelectItem, c as deleteAssetBlob, d as hydrateSeedAsset, i as SelectContent, l as getAssetBlob, n as Label, o as SelectTrigger, p as putAssetBlob, r as Select, s as SelectValue, t as Badge, u as hasAssetBlob } from "./select-DgCb9BIh.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/asset-storage-DgemP_iG.js
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/ui-store-BUAt6MQs.js
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/router-C_PWIgcC.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Sheet, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SheetContent, {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SheetTitle, { children: "畫布代理" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
...
function AppShell({ children }) {
	...
	function hrefFor(item) {
		...
		if (item.match === "export" && lastProjectId) return { to: "/export" };
		return { to: item.to };
	}
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: NAV.map((item) => {
							...
							return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
								to: dest.to,
								params: "params" in dest ? dest.params : void 0,
								className: cn("flex h-14 min-h-11 flex-col items-center justify-center gap-1 text-xs", active ? "text-fg" : "text-muted"),
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(item.icon, { className: "size-4" }), item.label]
							}, item.match);
						})
					})
			...
			current !== "assistant" && current !== "studio" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
				type: "button",
				onClick: () => setAssistantOpen(true),
...
var styles_default = "/assets/styles-0su5Zp02.css";
var APP_NAME = "構幀";
...
var $$splitComponentImporter$1 = () => import("./studio.index-CfLT4QgQ.mjs");
var Route$1 = createFileRoute("/studio/")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./studio._projectId-C3jWrMR4.mjs");
...
//#endregion
export { getAssetStorage as _, Sheet as a, AssistantForm as c, PlanResult as d, describeAdapter as f, useUi as g, toBriefInput as h, ScrollArea as i, BriefFields as l, getCampaignAiStatus as m, Route as n, SheetContent as o, generateCampaignPlan as p, SaveIndicator as r, SheetTitle as s, router_exports as t, EditorAgent as u };
